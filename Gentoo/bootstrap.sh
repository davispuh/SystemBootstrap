...
MAKERUBY='ruby19 ruby20 ruby21'
MAKEPYTHON='python2_7 python3_3'
MAKEINPUTDEVICES='evdev'
MAKEVIDEOCARDS='nouveau radeon'
...
DHCP=yes' > /etc/systemd/network/dhcp.network
    ...
    emerge app-portage/gentoolkit app-portage/layman sys-apps/mlocate app-editors/vim
